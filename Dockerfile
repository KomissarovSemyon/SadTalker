...
RUN git clone https://github.com/KomissarovSemyon/SadTalker.git

# Change the working directory to SadTalker
WORKDIR /app/SadTalker

# Install PyTorch with CUDA 11.3 support
RUN pip install torch==1.12.1+cu113-cp38-cp38-linux_x86_64 torchvision==0.13.1+cu113 torchaudio==0.12.1 --extra-index-url https://download.pytorch.org/whl/cu113
